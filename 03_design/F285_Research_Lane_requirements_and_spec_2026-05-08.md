---
title: F285 Research Lane 中長期銘柄発掘エンジン 仕様書 + 要件定義 v1.0
date: 2026-05-08
phase: F285-R0
status: 仕様設計完了 (HQ 5 点修正反映版、Phase R0 feasibility precheck 着手前)
...
# F285 Research Lane 中長期銘柄発掘エンジン 仕様書 + 要件定義 v1.0
...
役割: 業種別資金循環パターンを抽出、強い業種を up-flow / 弱い業種を
down-flow として日次・週次にラベリング。
